# Tulip Maps — the LIVE site (tulipmaps.com)
...
- **this one** → `tulipmaps.com`, the real site
- `tulip-maps-beta` → `beta.tulipmaps.com`, the playground

Work on beta first. When beta looks right, the `PUSH Tulip Maps live` button
copies beta onto this repo and publishes it. Both sit side by side on the Mac in
...
- **`web/index.html`** — the landing page, what you get at tulipmaps.com
- **`web/app/`** — the roadbook drawing tool, at tulipmaps.com/app/. The
